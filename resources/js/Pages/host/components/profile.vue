          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    <i class="bi bi-person-badge pe-2 text-primary"></i>
                    <span class="fw-bold">Last name:</span>
                    <span class="ps-3">{{ hostData?.last_name || 'N/A' }}</span>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    ...
                    <span class="ps-3">{{ hostData?.mobile_number || 'N/A' }}</span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    <i class="bi bi-envelope pe-2 text-primary"></i>
                    <span class="fw-bold">Email address:</span>
                    <div class=""></div>
                    <span class="ps-3">{{ hostData?.email || 'N/A' }}</span>
                  </div>
                </div>
              </div>
              <hr class="horizontal dark" />

              <p class="text-uppercase text-sm mb-3">Contact Information</p>
              <div class="row">
                <!-- Country -->
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    ...
                    <span class="ps-3">{{ hostData.address?.county || 'N/A' }}</span>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    ...
                    <span class="ps-3">{{ hostData.address?.region || 'N/A' }}</span>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    ...
                    <span class="ps-3">{{ hostData.address?.city || 'N/A' }}</span>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    ...
                    <span class="ps-3">{{ hostData.address?.street || 'N/A' }}</span>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    ...
                    <span class="fw-bold">Flat:</span>
                    <span class="ps-3">{{ hostData.address?.flat || 'N/A' }}</span>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group d-flex align-items-center">
                    ...
                    <span class="ps-3">{{ hostData.address?.post_code || 'N/A' }}</span>
                  </div>
                </div>
              </div>
              ...
              <p class="text-uppercase text-sm mb-3">Emergency Contact</p>
              <div class="row row-cols-1 row-cols-md-2">
                <!-- Email -->
                <div class="col">
                  <div class="form-group d-flex align-items-center gap-2">
                    <i class="bi bi-envelope-at text-warning"></i>
                    <span class="fw-bold">Email:</span>
                    <span class="ps-2">{{ hostData.emergency_contact?.email || 'N/A' }}</span>
                  </div>
                </div>
                ...
                <div class="col">
                  <div class="form-group d-flex align-items-center gap-2">
                    ...
                    <span class="ps-2">{{
                      hostData.emergency_contact?.mobile_number || 'N/A'
                    }}</span>
                  </div>
                </div>
                ...
                <div class="col">
                  <div class="form-group d-flex align-items-center gap-2">
                    ...
                    <span class="ps-2">{{
                      hostData.emergency_contact?.relationship || 'N/A'
                    }}</span>
                  </div>
                </div>
