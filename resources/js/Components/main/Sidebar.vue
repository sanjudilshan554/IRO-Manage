<template>
    <aside :class="{ 'sidebar-open': sidebarOpen }"
        ...
        <div class="align-item-center justify-content-center d-flex pt-4 pb-4">
            <Link :href="route('dashboard')"><span class="font-weight-bold">IRO - Management</span></Link>
        </div>
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <!-- Sign In -->
                    <div class="nav-link cursor-pointer d-flex align-items-center" @click.prevent="viewSignIn"
                        v-if="!user">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <!-- Logout -->
                    <div class="nav-link cursor-pointer d-flex align-items-center" @click.prevent="viewLogoutModal"
                        v-else>
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
